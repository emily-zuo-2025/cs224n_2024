...
class ParserModel(nn.Module):
    ...
    def embedding_lookup(self, w):
        ...
        # Lookup embeddings for each word index in w and reshape
        # w has shape (batch_size, n_features), we need output shape (batch_size, n_features * embed_size)
